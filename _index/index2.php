...
<head>
    ...
    <script src="professor_search.js" type="text/javascript"></script>
    <script src="professor_search1.js" type="text/javascript"></script>
    <meta charset="UTF-8">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="search_container" style="position: sticky; top: 0px; z-index: 999;">
                                ...
                                <div class="moveblog">
                                    ...
                                    <input type="search" id="search" placeholder="輸入教授名稱" style="display:inline;" />
                                    <input type="search" id="newCourseId" placeholder="評論" style="display:inline;" />
                                    <input type="search" id="grade" placeholder="評分(0-5)" style="display:inline;" />
                            ...
                            <div class="list_container" style="width: 100%; height: 100%; min-height: 200px;">
                                <div id="list_content" style="display: block; width: 100%; text-align: center;">
                                    <div id="list_head" class="list_lead_container" style="top: 0px">
                                        <div class="list_head" style="width:10%;">Id</div>
                                        <div class="list_head" style="width:20%;">教授</div>
                                        <div class="list_head" style="width:20%;">系所</div>
                                        <div class="list_head" style="width:20%;">系所代碼</div>
                                        <div class="list_head" style="width:20%;">評論</div>
                                        <div class="list_head" style="width:10%;">評分</div>
                                    </div>
                                    ...
                                    <div id="search_results">
                                        <div id="initial">
                                            <?php
                                            // 查詢並顯示當前學生的所有評論
                                            $sql = "SELECT * FROM professor INNER JOIN professor_info on professor.name = professor_info.name INNER JOIN department on professor_info.department_Id = department.depart_code_number WHERE sId = :studentId";
                                            ...
                                            ?>
                                                    <div class="course_info">
                                                        <span class='Id' style = "width: 10%;"><?= htmlspecialchars($row["Id"]) ?></span>
                                                        <span class='name' style = "width: 20%;"><?= htmlspecialchars($row["name"]) ?></span>
                                                        <span class='Id' style = "width: 20%;"><?= htmlspecialchars($row["dname"]) ?></span>
                                                        <span class='Id' style = "width: 20%;"><?= htmlspecialchars($row["depart_code_number"]) ?></span>
                                                        <span class='comment' style = "width: 20%;"><?= htmlspecialchars($row["comment"]) ?></span>
                                                        <span class='credits' style = "width: 10%;"><?= htmlspecialchars($row["credits"]) ?></span>
                                                    </div>
                                            <?php
                                                }
                                            } else {
                                    ...
                                    <div class="search_container">
                                        <input type="search" id="professor_search" placeholder="Search professors + department">
                                        <button id="search_button" onclick="searchProfessors()">Search</button>
                                    </div>
                                    <div id="search_results_container"></div>

                                    <div class="search_container">
                                        <input type="search" id="professor_search1" placeholder="Search professors + student">
                                        <button id="search_button" onclick="searchProfessors1()">Search</button>
                                    </div>
                                    <div id="search_results_container1"></div>

                                    <div class="search_container">
                                        <input type="search" id="professor_search2" placeholder="Search professors + test">
                                        <button id="search_button" onclick="searchProfessorsAndTest()">Search</button>
                                    </div>
                                    <div id="search_results_container2"></div>
                                    ...
                                    <!-- Add this new div to hold the search results -->
